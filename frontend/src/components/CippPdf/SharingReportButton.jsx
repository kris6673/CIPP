...
// The report PDF is now rendered server-side (ExecGetSharingReportPdf) via the shared CIPPSharp
// component kit. The button fetches the finished PDF as a blob for preview + download; the react-pdf
// SharingReportDocument above is retained for the branding-settings live preview.
