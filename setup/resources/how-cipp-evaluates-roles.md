...
For instructions on _creating_ roles and mapping them to Entra groups, see [Adding Users and Managing Roles](../../docs/setup/setting-up-cipp/roles.md).
