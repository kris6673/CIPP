...
* Set it up yourself – CIPP is completely free to self-host, and you can follow our detailed [setting-up-cipp](../../setup/setting-up-cipp/ "mention") Guide. The cost to run a self-hosted version is roughly $0.10 per day.&#x20;
* Try our hosted version – Visit [cipp.ms/getcipp](https://cipp.ms/getcipp) to get a subscription to CIPP. We only offer month-to-month subscription options. There are no long-term commitments, and you can cancel anytime. This is regarded as “Sponsorship”.&#x20;
