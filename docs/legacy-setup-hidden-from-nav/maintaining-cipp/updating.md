...
* If you’ve connected your Azure Function App to **GitHub Actions** ([Run From Package mode](/broken/pages/Pjb7aq2bQTrbFJQfLNNv)), the updates should roll out automatically within about 30 minutes.
