...
{% hint style="warning" %}
If you choose to subscribe and use the CyberDrain hosted version, you can skip over these steps and jump over to [sponsor-quick-start.md](../../setup/resources/sponsor-quick-start.md "mention") guide for further direction.
{% endhint %}
