...
This report provides an overview of the Multi-Factor Authentication (MFA) status for all users within the tenant. It combines the built-in Entra MFA report with the per-user MFA state to provide a complete picture.
