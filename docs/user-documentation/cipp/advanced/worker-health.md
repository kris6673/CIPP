...
The Job Queue lists the background jobs known to the worker system, newest first. A toggle above the table sets how many jobs to load (500, 2k, 5k, or 10k), and quick filters narrow the list to Queued, Running, or Failed jobs.
