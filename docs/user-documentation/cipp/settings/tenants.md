...
| **CopilotUsage**       | Copilot Usage User Detail, User Count Summary, User Count Trend, Readiness Activity                                                                                                                                                                                                                                                                                                                                                                            | None _(returns empty if no Copilot licences are assigned)_                                                                                                         |
...
| **Mailboxes**          | All mailboxes, including permissions, calendar rules, and forwarding _(runs as a dedicated activity)_                                                                                                                                                                                                                                                                                                                                                          | Exchange Online                                                                                                                                                    |
