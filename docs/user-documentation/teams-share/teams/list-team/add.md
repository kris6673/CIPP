...
Creates a new team in the selected tenant, using Microsoft's standard team template. The Microsoft 365 group behind the team, including its mail nickname, is created automatically from the display name.
