...
One important caveat: multi-tenant mode currently accepts sign-ins from any Entra ID tenant. Whether a user can actually reach CIPP is still governed by the [cipp-users.md](../../../../docs/user-documentation/cipp/advanced/super-admin/cipp-users.md "mention") list and the roles assigned there, so only the intended users should be added.
...
3. On the [cipp-users.md](../../../../docs/user-documentation/cipp/advanced/super-admin/cipp-users.md "mention") page, add the users who should have access and assign them appropriate roles.
