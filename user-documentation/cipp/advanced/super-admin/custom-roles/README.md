...
A page for super admins to manage the custom roles deployed to their CIPP instance. Please see the User Roles in CIPP page on [#custom-roles](../../../../../docs/setup/setting-up-cipp/roles.md#custom-roles "mention") for instructions and notes/limitations.
